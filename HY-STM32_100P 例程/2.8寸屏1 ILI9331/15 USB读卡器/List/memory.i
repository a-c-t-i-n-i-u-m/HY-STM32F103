#line 1 "usb_library\\src\\memory.c"
...
#line 18 "usb_library\\src\\memory.c"
#line 1 ".\\usb_library\\inc\\memory.h"
...
#line 22 ".\\usb_library\\inc\\memory.h"
...
#line 19 "usb_library\\src\\memory.c"
#line 1 ".\\usb_library\\inc\\usb_scsi.h"
...
#line 22 ".\\usb_library\\inc\\usb_scsi.h"

 
 

 
#line 38 ".\\usb_library\\inc\\usb_scsi.h"




#line 49 ".\\usb_library\\inc\\usb_scsi.h"
...
#line 64 ".\\usb_library\\inc\\usb_scsi.h"


#line 73 ".\\usb_library\\inc\\usb_scsi.h"
...
#line 117 ".\\usb_library\\inc\\usb_scsi.h"



 

#line 20 "usb_library\\src\\memory.c"
#line 1 ".\\usb_library\\inc\\usb_bot.h"
...
#line 22 ".\\usb_library\\inc\\usb_bot.h"
#line 23 ".\\usb_library\\inc\\usb_bot.h"
...
#line 60 ".\\usb_library\\inc\\usb_bot.h"
...
#line 21 "usb_library\\src\\memory.c"
#line 22 "usb_library\\src\\memory.c"
...
#line 23 "usb_library\\src\\memory.c"
...
vu32 Counter = 0;
u32 i;
u32 Data_Buffer[0x00000040 * 2];  
u8 Data1_Buffer[0x00000040 * 8];  
...
{ unsigned int a=0,b=0;	 
  ...
  {	
    ...
    UserToPMABufferCopy(Data1_Buffer, (0x98), 0x00000040);
    Block_Read_count = 512 - 0x00000040;
    Block_offset = 0x00000040;	 
	
  }
  else
  {
    UserToPMABufferCopy(Data1_Buffer + Block_offset, (0x98), 0x00000040);
    Block_Read_count -= 0x00000040;
    Block_offset += 0x00000040;
	
  }

  SetEPTxCount(((u8)1), 0x00000040);
  SetEPTxStatus(((u8)1), (0x0030));


  Memory_Offset += 0x00000040;
  Transfer_Length -= 0x00000040;

  CSW.dDataResidue -= 0x00000040;
...
{ unsigned int a=0,b=0;
  ...
  if ((Transfer_Length == 0) || (Bot_State == 4))
  {
    Counter = 0;
    Set_CSW (0x00, 1);
