...
#line 25 "user\\hw_config.c"
 
 
#line 33 "user\\hw_config.c"
...
void Set_System(void)
{
  ...
  RCC_APB2PeriphClockCmd(((uint32_t)0x00000004) | ((uint32_t)0x00000010) | ((uint32_t)0x00000040), ENABLE);
  ...
  GPIO_InitStructure.GPIO_Pin = ((uint16_t)0x2000)|((uint16_t)0x1000);
  GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
  GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IPU;
  GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), &GPIO_InitStructure);
...
u8 JoyState(void)
{
  ...
  if (!GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800)), ((uint16_t)0x0010)))
  {
    return 3;
  }
   
  if (!GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800)), ((uint16_t)0x0020)))
  {
    return 2;
  }
   
  if (!GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800)), ((uint16_t)0x0004)))
  {
    return 4;
  }
   
  if (!GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800)), ((uint16_t)0x0008)))
  {
    return 1;
  }
  if (!GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), ((uint16_t)0x2000)))
  {
    return 5;
  }
   if (!GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), ((uint16_t)0x1000)))
  {
    return 6;
  }
