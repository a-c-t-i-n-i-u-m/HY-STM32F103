...
#line 28 ".\\FWlib\\inc\\stm32f10x_exti.h"
...
#line 114 ".\\FWlib\\inc\\stm32f10x_exti.h"



#line 127 ".\\FWlib\\inc\\stm32f10x_exti.h"
...
#line 23 "FWlib\\SRC\\stm32f10x_exti.c"
...
void EXTI_DeInit(void)
{
  ...
  ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0400))->PR = 0x0007FFFF;
}
...
void EXTI_Init(EXTI_InitTypeDef* EXTI_InitStruct)
{
  ...
  if (EXTI_InitStruct->EXTI_LineCmd != DISABLE)
  {
    ...
    *(volatile uint32_t *)(((((uint32_t)0x40000000) + 0x10000) + 0x0400) + (uint32_t)EXTI_InitStruct->EXTI_Mode)|= EXTI_InitStruct->EXTI_Line;
    ...
    {
      *(volatile uint32_t *)(((((uint32_t)0x40000000) + 0x10000) + 0x0400) + (uint32_t)EXTI_InitStruct->EXTI_Trigger)|= EXTI_InitStruct->EXTI_Line;
    }
  }
  else
  {
