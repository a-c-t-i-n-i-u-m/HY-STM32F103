...
void RTC_IRQHandler(void)
{
  if(RTC_GetITStatus(((uint16_t)0x0001)) != RESET)
  {
    ...
    RTC_ClearITPendingBit(((uint16_t)0x0001));
    
     
    GPIO_WriteBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), ((uint16_t)0x0040), (BitAction)(1-GPIO_ReadOutputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), ((uint16_t)0x0040))));
